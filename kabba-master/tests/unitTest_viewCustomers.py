...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        elem = driver.find_element(By.XPATH, '/html/body/div/div[3]/div/table/tbody/tr[1]/td[13]/a').click()

        time.sleep(5)  # pause to allow screen to change
        try:
            # verify Summary button exists on new screen after clicking "Customers" button
            elem = driver.find_element(By.XPATH, '/html/body/div/div[3]/div/table/tbody/tr[1]/td[13]/a')
